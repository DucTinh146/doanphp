...
<?php
    ...
    $query_sua_danhmucbv = mysqli_query($mysqli,$sql_sua_danhmucbaiviet);
?>
...
<table border="1" width="50%" style="border-collapse: collapse">
 <form method="POST" action="modules/quanlydanhmucbaiviet/xuly.php?idbaiviet=<?php echo $_GET['idbaiviet']?>">
    ...
    ?>
        ...
        <td><input type="text" value="<?php echo $dong['tendanhmuc_baiviet']?>" name="tendanhmucbaiviet" rows="10px"></td>
        </tr>
        <tr>
            <td>Thứ tự</td>
