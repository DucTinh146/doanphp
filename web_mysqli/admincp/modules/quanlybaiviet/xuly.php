...
include ('../../config/config.php');
    ...
    if(isset($_POST['thembaiviet'])){
        $sql_them = "INSERT INTO tbl_baiviet(tenbaiviet,tomtat,noidung,id_danhmuc,tinhtrang,hinhanh) VALUE ('".$tenbaiviet."',
        '".$tomtat."','".$noidung."','".$danhmuc."','".$tinhtrang."','".$hinhanh."')";
    ...
    elseif(isset($_POST['suabaiviet'])){
        if(!empty($_FILES['hinhanh']['name'])){
            ...
            id_danhmuc='".$danhmuc."',tinhtrang='".$tinhtrang."',hinhanh='".$hinhanh."' WHERE id='$_GET[idbaiviet]'";

        }else{
            $sql_update="UPDATE tbl_baiviet SET tenbaiviet='".$tenbaiviet."',tomtat='".$tomtat."',noidung='".$noidung."',
            id_danhmuc='".$danhmuc."',tinhtrang='".$tinhtrang."' WHERE id='$_GET[idbaiviet]'";
        }
