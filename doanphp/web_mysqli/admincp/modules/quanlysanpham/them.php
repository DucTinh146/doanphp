...
<table border="1" width="100%" style="border-collapse: collapse">
 <form method="POST" action="modules/quanlysanpham/xuly.php" enctype="multipart/form-data">
        ...
        <tr>
            <td>Tên sản phẩm</td>
        <td><input type="text" name="tensanpham" rows="10px"></td>
        </tr>
        <tr>
            <td>Mã sản phẩm</td>
        <td><input type="text" name="masanpham" rows="10px"></td>
        </tr>
        <tr>
            <td>Giá sản phẩm</td>
        <td><input type="text" name="giasanpham" rows="10px"></td>
        </tr>
        <tr>
            <td>Số lượng</td>
        <td><input type="text" name="soluong" rows="10px"></td>
        </tr>
        <tr>
            <td>Hình ảnh </td>
