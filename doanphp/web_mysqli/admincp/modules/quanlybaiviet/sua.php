...
<?php
    ...
    $query_suabaiviet = mysqli_query($mysqli,$sql_sua_baiviet);
?>
...
<?php
    while($row =mysqli_fetch_array($query_suabaiviet)){

    
?>
        <tr>
            <td>Tên bài viết</td>
        <td><input type="text" value="<?php echo $row['tenbaiviet'] ?>" name="tenbaiviet" rows="10px"></td>
        </tr>
        <tr>
            <td>Hình ảnh </td>
            <td>
        ...
        <tr>
            <td>Tóm tắt </td>
        <td><textarea rows="10" width="100%" name="tomtat" style="resize:none" ><?php $row['tomtat']  ?></textarea></td>
        </tr>
        <tr>
            <td>Nội dung</td>
        <td><textarea rows="10" width="100%" name="noidung" style="resize:none"><?php $row['noidung']  ?></textarea></td>
        </tr>
        <tr>
